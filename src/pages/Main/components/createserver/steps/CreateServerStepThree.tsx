...
export default function CreateServerStepThree({ closeModal, setStep }: StepOneProps) {
  return (
    <div className="w-[600px] pb-[100px] gap-2 flex flex-col justify-center items-center thin-scroll relative">
      ...
      <div className="flex flex-col py-4 absolute bottom-0 left-0 px-4 justify-center gap-2 items-center bg-skin-blue w-full h-[100px] text-skin-inverted">
        <h3 className="font-bold text-lg">Cory like burgers</h3>
        <button
          onClick={() => setStep(0)}
